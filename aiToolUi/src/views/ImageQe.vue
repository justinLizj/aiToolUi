...
export default {
  ...
  setup() {
    debugger;
    const models = [
      {text: "效果1", value: "1", img: "/images/mj/hzp_mx2.png"},
      {text: "效果2", value: "2", img: "/images/mj/hzp_mx2.png"},
    ]
    ...
    onMounted(() => {
      ...
      window.document.getElementById("targetId").style.height=(window.innerHeight/2-(window.innerHeight/6)-55) + "px";
